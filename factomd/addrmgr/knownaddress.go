...
// NetAddress returns the underlying factomwire.NetAddress associated with the
// known address.
func (ka *knownAddress) NetAddress() *factomwire.NetAddress {
	return ka.na
}
