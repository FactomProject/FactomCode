...
func (msg *MsgGetCredit) BtcEncode(w io.Writer, pver uint32) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCredit) BtcDecode(r io.Reader, pver uint32) error {
	bytes, err := readVarBytes(r, pver, uint32(notaryapi.HashSize), CmdGetCredit)
	if err != nil {
		return err
	}
...
func (msg *MsgGetCredit) Command() string {
	return CmdGetCredit
}

// MaxPayloadLength returns the maximum length the payload can be for the
// receiver.  This is part of the Message interface implementation.
func (msg *MsgGetCredit) MaxPayloadLength(pver uint32) uint32 {
	return MaxAppMsgPayload
}

// NewMsgInv returns a new bitcoin inv message that conforms to the Message
// interface.  See MsgInv for details.
func NewMsgGetCredit() *MsgGetCredit {
	return &MsgGetCredit{}
}
