...
func NewEntryOfType(dataType EntryDataType) *Entry {
	switch dataType {
	case PlainDataType:
...
func (e *Entry) Type() EntryDataType {
	if e.EntryData == nil {
...
func (e *Entry) Version() EntryDataVersion {
	if e.EntryData == nil {
...
func (e *Entry) Decoding(unmarshaller gocoding.Unmarshaller, theType reflect.Type) gocoding.Decoder {
	return func(scratch [64]byte, scanner gocoding.Scanner, value reflect.Value) {
		...
		if value.IsNil() {
			value.Set(reflect.ValueOf(new(Entry)))
		}
...
func NewUTF8Entry(str string) *Entry {
