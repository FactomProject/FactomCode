...
//	fmt.Println("hashes.len=", len(hashes), ", nextPoT=", nextPoT, ", array.size=", arraySize)
	...
	for i := 0; i < arraySize-1; i += 2 {
		...
		case merkles[i] == nil:
			merkles[offset] = nil
			fmt.Println("NO left child node")
		...
		case merkles[i+1] == nil:
			...
			fmt.Println("NO right child merkles[%v]:%v", offset, merkles[offset].String())			
		...
		default:
			...
			merkles[offset] = newSha
			fmt.Println("Inside merkles[%v]:%v", offset, merkles[offset].String())
		}
		offset++
	}
