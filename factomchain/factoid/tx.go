...
type Tx struct {
	msgTx   *factomwire.MsgTx   // Underlying MsgTx
	txSha   *factomwire.ShaHash // Cached transaction hash
	txIndex int              // Position within a block or TxIndexUnknown
}

// MsgTx returns the underlying factomwire.MsgTx for the transaction.
func (t *Tx) MsgTx() *factomwire.MsgTx {
	// Return the cached transaction.
	return t.msgTx
}

// Sha returns the hash of the transaction.  This is equivalent to
// calling TxSha on the underlying factomwire.MsgTx, however it caches the
// result so subsequent calls are more efficient.
func (t *Tx) Sha() *factomwire.ShaHash {
...
// factomwire.MsgTx.  See Tx.
func NewTx(msgTx *factomwire.MsgTx) *Tx {
	return &Tx{
		msgTx:   msgTx,
