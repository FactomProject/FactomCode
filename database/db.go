...
type Db interface {
	...
	UpdateSyncupBlockHeightCache(dirBlkHeigh uint32) error

	// FetchSyncupBlockHeightCache returns the latest downloaded block height
	FetchSyncupBlockHeightCache() (height int64)	
