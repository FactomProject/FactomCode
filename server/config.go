...
// config defines the configuration options for factomd peerss.
//
...
// serviceOptions defines the configuration options for factomd as a service on
// Windows.
...
//
// The above results in factomd functioning properly without any config settings
